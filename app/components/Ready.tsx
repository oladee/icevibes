...
const Ready = ()=>{
    return(<div className="bg-[#FDAC18] py-16 px-5 lg:py-[120px] lg:px-[8.33vw]">
        ...
        <div className="mt-12 lg:mt-20 flex justify-center">
            <Link href='' className='bg-[#7A33FF] font-switzer lg:text-[1.11vw] text-white font-medium border-r-[6px] border-b-[6px] border-t border-l border-[#000] transition-all duration-300 hover:border-0 py-4 lg:px-8 rounded-lg'>
