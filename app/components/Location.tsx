  ...
  return(<div className="bg-[#000] lg:py-[120px] py-12 px-8 lg:px-[8.33vw]">
    ...
    <div className="flex flex-col lg:flex-row lg:justify-evenly gap-7 mt-7 lg:mt-14">
        <div className="flex flex-col items-center">
            ...
            <div className="bg-[#FDAC18] text-white text-center -rotate-[7deg] py-2 mt-2 lg:py-6 lg:px-8 rounded-xl lg:w-[27.29vw] h-[90px] lg:h-[129px]">
        ...
        <div className="flex flex-col items-center text-center text-white">
            ...
            <div className="bg-[#7A33FF] -rotate-[7deg] w-full py-2 mt-2 lg:px-8 lg:py-6 rounded lg:rounded-xl lg:w-[27.29vw] h-[90px] lg:h-[129px] space-y-2">
                <h4 className="font-beachday text-2xl lg:text-[32px]">
                    WHEN?
                </h4>
                <p className="font-switzer text-sm lg:text-2xl font-semibold">
