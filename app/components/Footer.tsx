...
const Footer = ()=>{
    ...
    return(<div className='bg-[#000] py-16 px-5 lg:py-[120px] lg:px-[8.33vw] relative'>
        <div className="lg:px-20 w-full relative bg-red-600">
            <video ref={videoRef} autoPlay muted disablePictureInPicture loop playsInline width={320} height={320} className="lg:h-[501px] lg:w-[69.44vw] object-cover rounded-xl z-50">
