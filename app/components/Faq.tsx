...
const Faq = ()=>{
    ...
    return(<div className="py-16 px-5 lg:py-[120px] lg:px-[8.33vw]">
        ...
        <section className="flex flex-col lg:flex-row lg:gap-[120px]">
            ...
            <div className="hidden lg:block py-9 lg:w-[34.09vw] px-8 border-r-8 border-b-8 border-t border-l border-[#000] rounded-2xl">
...
export const Accordion = ({question, answer, idx, setAccordIdx, currentAccord, handleToggleAccord}: {question : string, answer : string, idx : number, currentAccord : number | null, setAccordIdx : (item : number)=>void, handleToggleAccord : (item : number | null)=>void})=>{
    ...
    return(<div>
        <div className={clsx(`bg-white flex cursor-pointer items-center justify-between border-r-[6px] border-b-[6px] border-t border-l border-[#000] p-4 rounded-xl lg:w-[589px]`, currentAccord === idx && ` bg-[#7A33FF] border-[#FDAC18] text-white`)} onClick={handleclick}>
        ...
        <div className="lg:hidden">
            {
                currentAccord == idx &&
                (<div className=" mt-3 py-9 lg:w-[34.09vw] px-8 border-r-8 border-b-8 border-t border-l border-[#000] rounded-2xl">
                    <h2 className="text-[#7A33FF] lg:text-[32px] lg:py-8 bg-[#BBE4FF] text-center text-beachday rounded-3xl">
                        ANSWER
                    </h2>
