...
const Hero =  ()=>{
    return(<div className="bg-[#7A33FF] bg-herobgmob bg-cover  lg:bg-herobg lg:bg-auto h-full bg-[100%_96%]  lg:bg-[0%_96%]  bg-no-repeat lg:px-[120px] lg:pb-96 relative">
        ...
        <div className="md:py-8 lg:py-[120px] flex flex-col items-center lg:items-start">
            ...
            <Link href='https://events.nairabox.com/event/676e8d6adadb460623d3951f' target="_blank" className="bg-[#EA9B0B] font-switzer lg:text-[1.11vw] text-white font-medium border-r-[6px] border-b-[6px] border-t border-l border-[#000] transition-all duration-300 hover:border-0 py-5 px-8 lg:px-8 rounded-lg">
